...
using Travel.Models.ManageViewModels;
...
namespace Travel.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> HistoryList()
        {
            ...
            var bill = _billService.GetAll().Where(x => x.CustomerId == user.Id).OrderBy(x => x.BillStatus);
        ...
        public async Task<IActionResult> UpdateProfile()
        {
            ...
            if (user == null)
            {
                throw new ApplicationException($"Người dùng không tồn tại'{_userManager.GetUserId(User)}'.");
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> UpdateProfile(AppUserViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
