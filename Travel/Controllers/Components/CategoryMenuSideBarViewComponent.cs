...
{
    public class CategoryMenuSideBarViewComponent : ViewComponent
    {

        private ITourCategoryService _TourCategoryService;
        private IMemoryCache _memoryCache;
        public CategoryMenuSideBarViewComponent(ITourCategoryService TourCategoryService, IMemoryCache memoryCache)
        {
