...
namespace Travel.Data.EF.Migrations
{
    ...
    [Migration("20200619075311_add-comp-bill")]
    partial class addcompbill
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Travel.Data.Entities.CompletedBill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("CompletedBills");
                });

            modelBuilder.Entity("Travel.Data.Entities.CompletedBillDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("CompletedBillDetails");
                });
            ...
            modelBuilder.Entity("Travel.Data.Entities.CompletedBillDetail", b =>
                {
                    b.HasOne("Travel.Data.Entities.CompletedBill", "CompletedBill")
                        .WithMany("CompletedBillDetails")
                        .HasForeignKey("BillId")
                        .OnDelete(DeleteBehavior.Cascade);
