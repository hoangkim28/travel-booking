        ...
        public async Task Seed()
        {
            ...
            if (_context.Functions.Count() == 0)
            {
                _context.Functions.AddRange(new List<Function>()
                {
                    ...
                    new Function() {Id = "TOUR_CATEGORY",Name = "Quản lý Danh mục tour",ParentId = "TOUR",SortOrder =1,Status = Status.Active,URL = "/admin/Tourcategory/index",IconCss = "fa-chevron-down"  },
                    new Function() {Id = "TOUR_LIST",Name = "Quản lý Danh sách Tour",ParentId = "TOUR",SortOrder = 2,Status = Status.Active,URL = "/admin/Tour/index",IconCss = "fa-chevron-down"  },
                    ...
                    new Function() {Id = "BILL",Name = "Đơn đặt",ParentId = "ORDER",SortOrder = 3,Status = Status.Active,URL = "/admin/bill/index",IconCss = "fa-chevron-down"  },
                    new Function() {Id = "BILLCOMPLETED",Name = "Hóa đơn",ParentId = "ORDER",SortOrder =1,Status = Status.Active,URL = "/admin/BillCompleted/index",IconCss = "fa-chevron-down"  },
                    ...
                    new Function() {Id = "PLACE",Name = "Quản lý Địa điểm",ParentId = "TOUR",SortOrder = 6,Status = Status.Active,URL = "/admin/place/index",IconCss = "fa-clone"  },
                });
            }
